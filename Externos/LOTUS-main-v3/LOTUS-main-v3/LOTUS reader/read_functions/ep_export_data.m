...
%  with the LOTUS Toolkit. If not, see https://www.gnu.org/licenses/.
    ...
    switch cfg.read_method
        ...
        case 'Default'
            ...
            % Añado el filtro de media móvil para la tónica y fásica
            dat = filtrosEmpatica(dat);

            % Aplico signo negativo a la señal BVP para obtener los picos
            % sistólicos como máximos y no mínimos.
            dat.BVP{1}.data = -dat.BVP{1}.data;
