...
figure
plot(caneDataExperiment.(experimentNames{i}).PPG.TimeStampPosix,canePPG,'o-')
hold on
...
plot(timestampCaneWin(zeroCane), ppgCaneWin(zeroCane),'*')
plot(timestampCaneWin([1,end]),[cane_umbral,cane_umbral])
...
plot(cane_umbral_time,cane_umbral_array)
